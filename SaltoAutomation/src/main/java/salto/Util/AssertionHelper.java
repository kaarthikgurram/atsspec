...
public class AssertionHelper extends TestBase{
	...
	public static final Logger log =Logger.getLogger(AssertionHelper.class.getName());
	...
	public static void verifyInt(int s1, int s2){
		log.info("veryfing test: "+ s1 + " with "+ s2);
		Assert.assertEquals(s1, s1);
	}
	...
	public static void verifyTextsoft(String s1, String s2){
		log.info("veryfing test: "+ s1 + " with "+ s2);
